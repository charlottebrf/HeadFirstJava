...
public static void main (String[] args) {
  ...
  //Math random method returns a number from 0 to just less than 1 , this formula with the cast returns a number from 0 - 4
  ...
  while (isAlive == true) {
    ...
    //Game helper instance - passes in the user input
